...
fn test_unicode_daw() {
    ...
    test.press('w').keys("daw"); // Delete around word
...
fn test_search_unicode() {
    ...
    test.press('/').type_text("世界").press_enter();
...
fn test_search_emoji() {
    ...
    test.press('/').type_text("😀").press_enter().press('n'); // Next match
...
fn test_visual_select_emoji() {
    ...
    test.press('w').press('v').keys("lll"); // Select emojis
...
fn test_insert_unicode() {
    ...
    test.press('a').type_text(" 世界").press_esc();
...
fn test_zero_with_unicode() {
    ...
    test.keys("$").keys("0"); // Beginning with unicode
...
fn test_replace_unicode_with_ascii() {
    ...
    test.press('r').press('x'); // Replace Chinese with 'x'
...
fn test_tab_character() {
    ...
    test.press('l').press('l').press('l').press('l').press('l'); // Move through tab
