...
# Uses proper JSON-RPC communication with Content-Length headers and CRLF line endings
...
# Send all messages to rust-analyzer
{
    ...
    sleep 1
} | rust-analyzer 2>&1 | tee /tmp/ra_output.log

echo "" >&2
echo "=== Test complete ===" >&2
echo "Output saved to /tmp/ra_output.log" >&2
