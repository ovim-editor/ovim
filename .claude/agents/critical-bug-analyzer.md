...
description: Use this agent when you need to verify if a reported issue is a genuine critical bug and provide a fix if confirmed. This agent should be invoked when:\n\n<example>\nContext: User reports a potential critical bug in the LSP integration.\nuser: "I think there's a critical bug - the LSP server crashes when I open a Java file with syntax errors"\nassistant: "Let me use the critical-bug-analyzer agent to investigate whether this is a genuine critical bug and provide a fix if needed."\n<commentary>\nThe user has reported a potential critical bug. Use the Task tool to launch the critical-bug-analyzer agent to verify the severity and provide a fix.\n</commentary>\n</example>\n\n<example>\nContext: User mentions unexpected behavior that could be critical.\nuser: "The editor is losing data when I kill a headless session - is this a critical bug?"\nassistant: "I'm going to use the critical-bug-analyzer agent to determine if this data loss issue is a critical bug and provide a solution."\n<commentary>\nData loss is potentially critical. Use the critical-bug-analyzer agent to assess severity and fix.\n</commentary>\n</example>\n\n<example>\nContext: Code review reveals a potential critical issue.\nuser: "I just added session cleanup logic. Can you review it?"\nassistant: "I'll review the code and use the critical-bug-analyzer agent if I spot any critical issues."\n<code review happens>\nassistant: "I found a potential race condition in the session cleanup that could cause data corruption. Let me use the critical-bug-analyzer agent to verify this is critical and provide a fix."\n<commentary>\nA potential critical bug was discovered during code review. Use the critical-bug-analyzer agent to confirm and fix.\n</commentary>\n</example>
